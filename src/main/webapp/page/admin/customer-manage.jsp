                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${u.roleId == 1}">
                                        <span class="badge bg-danger">Admin Tổng</span>
                                    </c:when>
                                    <c:when test="${u.roleId == 3}">
                                        <span class="badge bg-primary">Admin Đơn Hàng</span>
                                    </c:when>
                                    <c:when test="${u.roleId == 4}">
                                        <span class="badge bg-success">Admin Sản Phẩm & Kho</span>
                                    </c:when>
                                    <c:when test="${u.roleId == 5}">
                                        <span class="badge bg-warning text-dark">Admin CSKH</span>
                                    </c:when>
                                    <c:otherwise>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="roleId" required>
                                        <option value="1" <c:if test="${detailUser.roleId == 1}">selected</c:if>>1 - Admin Tổng</option>
                                        <option value="2" <c:if test="${detailUser.roleId == 2}">selected</c:if>>2 - Người Dùng</option>
                                        <option value="3" <c:if test="${detailUser.roleId == 3}">selected</c:if>>3 - Admin Đơn Hàng</option>
                                        <option value="4" <c:if test="${detailUser.roleId == 4}">selected</c:if>>4 - Admin Sản Phẩm & Kho</option>
                                        <option value="5" <c:if test="${detailUser.roleId == 5}">selected</c:if>>5 - Admin CSKH</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
