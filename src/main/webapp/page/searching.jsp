...
<section class="phan-san-pham">
    ...
    <c:if test="${empty products}">
        <div class="text-center my-4 py-4" style="background-color: #f8f9fa; border-radius: 8px;">
            <i class="bi bi-search" style="font-size: 3rem; color: #adb5bd;"></i>
            <h5 class="mt-3 text-secondary">Không tìm thấy sản phẩm nào phù hợp với từ khóa "${keyword}".</h5>
        </div>
    </c:if>
